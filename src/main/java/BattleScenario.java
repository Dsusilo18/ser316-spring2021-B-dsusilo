public class BattleScenario {
    ...
    public void setMon2(Mascotmon pMon){
      ...
      * If the initial pAttack.damage is 0, then the damage dealt is 0. 
      * If the totalDamage calculated is negative, the totalDamage dealt should be 1. 
      * Any positive value is the total damage dealt.
      * 
      * Weather bonus: see the Environment which you can assume is correct. You do need to 
      * check if the weather bonus is applied correctly, since maybe the method does not 
      * use the environment correctly.On attack or defense, the monster have a buff,
      * debuff or nothing based on the weather. EG. fire monsters have a stat advantage 
      * of +25% in sunny weather while they have a stat disadvantage of -25% in the rain.
      * 
      * If the attack chosen, matches the monsters type, the attacker will get an 
      * extra 20% on its attack.
      * Type bonus: Certain monsters have an type bonus against others (bonuses:
